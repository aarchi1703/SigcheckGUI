...
### 1. YARA Engine
- Файл `yara64.exe` (встроен в проект)
...
- Скачайте актуальную версию с официального сайта (https://github.com/VirusTotal/yara/releases)
...
- Изменения применяются немедленно без перезапуска приложения (можно нажать кнопку "Обновить")
